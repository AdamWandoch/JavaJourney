...
- [x] [practice](https://github.com/AdamWandoch/JavaJourney/tree/master/src/com) core Java on:
  - [CodingBat](https://codingbat.com/java) # Count: 138 | check [CODE](https://github.com/AdamWandoch/JavaJourney/tree/master/src/com/codingbat) and [PROGRESS](https://codingbat.com/done?user=wandoch.adam@gmail.com&tag=2797055556)
  - [Exercism](https://exercism.org/tracks/java) # check [PROGRESS](https://exercism.org/profiles/AdamWandoch) "You’re 3.9% through the Java track"
